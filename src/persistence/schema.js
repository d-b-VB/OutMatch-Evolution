...
export function validateRunProgressRecord(record) {
  ...
  if (!Array.isArray(record.tentativeElites) || !Array.isArray(record.challengerHistory)
    || (record.childCandidate !== null && typeof record.childCandidate !== "object")) {
    throw new Error("Progress record is missing resumable tournament state");
  }
  return record;
}
