...
Step 4 stores run metadata, immutable completed generations and ledgers, resumable progress, settings, and optional replays in versioned IndexedDB stores.
...
The suite covers schema upgrades, repositories, pause/reopen/resume execution, immutable finalization, replay storage, cleanup, and storage-quota behavior.
